...
while.body2:
  ...
  %v6 = srem i32 %v5, 10
  %v7 = load i32, i32* %t2
  %t11 = getelementptr [4 x i32], [4 x i32]* %t1, i32 0, i32 %v7
  store i32 %v6, i32* %t11
  %v8 = load i32, i32* %t0
  %v9 = sdiv i32 %v8, 10
  store i32 %v9, i32* %t0
  %v10 = load i32, i32* %t2
...
while.end3:
  %v12 = alloca i32
  store i32 0, i32* %v12
  %t17 = getelementptr [4 x i32], [4 x i32]* %t1, i32 0, i32 0
  %v13 = load i32, i32* %t17
  %t19 = getelementptr [4 x i32], [4 x i32]* %t1, i32 0, i32 3
...
if.end6:
  ...
  ret i32 %v26
land.rhs7:
  %t24 = getelementptr [4 x i32], [4 x i32]* %t1, i32 0, i32 1
  %v18 = load i32, i32* %t24
  %t26 = getelementptr [4 x i32], [4 x i32]* %t1, i32 0, i32 2
...
entry:
  %t35 = alloca i32
  store i32 1221, i32* %t35
  %t36 = alloca i32
  %v1 = load i32, i32* %t35
  %v2 = call i32 @palindrome(i32 %v1)
  store i32 %v2, i32* %t36
  %v3 = load i32, i32* %t36
  %v4 = icmp eq i32 %v3, 1
