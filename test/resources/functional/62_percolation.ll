...
while.body2:
  %.v9 = sub i32 0, 1
  %.v10 = load i32, i32* %i
  %t10 = sext i32 %.v10 to i64
  %t11 = getelementptr [110 x i32], [110 x i32]* @array, i64 0, i64 %t10
...
entry:
  ...
  %t15 = sext i32 %.v1 to i64
  %t16 = getelementptr [110 x i32], [110 x i32]* @array, i64 0, i64 %t15
  %.v2 = load i32, i32* %t16
...
if.else2:
  ...
  %t25 = getelementptr [110 x i32], [110 x i32]* @array, i64 0, i64 %t24
  %.v9 = load i32, i32* %t25
  %.v10 = call i32 @findfa(i32 %.v9)
  %.v11 = load i32, i32* %a.addr
  %t29 = sext i32 %.v11 to i64
  %t30 = getelementptr [110 x i32], [110 x i32]* @array, i64 0, i64 %t29
  store i32 %.v10, i32* %t30
  %.v12 = load i32, i32* %a.addr
  %t32 = sext i32 %.v12 to i64
  %t33 = getelementptr [110 x i32], [110 x i32]* @array, i64 0, i64 %t32
...
if.then1:
  %.v10 = load i32, i32* %n
  %.v11 = load i32, i32* %m
  %t46 = sext i32 %.v11 to i64
  %t47 = getelementptr [110 x i32], [110 x i32]* @array, i64 0, i64 %t46
  store i32 %.v10, i32* %t47
  br label %if.end2
if.end2:
  ret void
}
...
if.then7:
  ...
  %t76 = sext i32 %.v28 to i64
  %t77 = getelementptr [110 x i32], [110 x i32]* @array, i64 0, i64 %t76
  store i32 %.v27, i32* %t77
  %.v29 = load i32, i32* %a
...
if.then9:
  ...
  %t83 = getelementptr [110 x i32], [110 x i32]* @array, i64 0, i64 %t82
  store i32 0, i32* %t83
...
if.then11:
  %.v39 = load i32, i32* %k
  %.v40 = load i32, i32* %k
  %t92 = sext i32 %.v40 to i64
  %t93 = getelementptr [110 x i32], [110 x i32]* @array, i64 0, i64 %t92
  store i32 %.v39, i32* %t93
...
land.rhs15:
  ...
  %.v50 = add i32 %.v49, 1
  %t103 = sext i32 %.v50 to i64
  %t104 = getelementptr [110 x i32], [110 x i32]* @array, i64 0, i64 %t103
  %.v51 = load i32, i32* %t104
  %.v52 = sub i32 0, 1
...
land.rhs19:
  ...
  %.v68 = sub i32 %.v67, 1
  %t122 = sext i32 %.v68 to i64
  %t123 = getelementptr [110 x i32], [110 x i32]* @array, i64 0, i64 %t122
  %.v69 = load i32, i32* %t123
  %.v70 = sub i32 0, 1
...
land.rhs23:
  ...
  %.v87 = load i32, i32* @n
  %.v88 = add i32 %.v86, %.v87
  %t143 = sext i32 %.v88 to i64
  %t144 = getelementptr [110 x i32], [110 x i32]* @array, i64 0, i64 %t143
  %.v89 = load i32, i32* %t144
  %.v90 = sub i32 0, 1
...
if.end26:
  ...
  %t179 = getelementptr [110 x i32], [110 x i32]* @array, i64 0, i64 %t178
  %.v123 = load i32, i32* %t179
  %.v124 = sub i32 0, 1
...
land.rhs27:
  ...
  %t164 = sext i32 %.v108 to i64
  %t165 = getelementptr [110 x i32], [110 x i32]* @array, i64 0, i64 %t164
  %.v109 = load i32, i32* %t165
  %.v110 = sub i32 0, 1
...
land.rhs31:
  %.v128 = load i32, i32* %k
  %t186 = sext i32 %.v128 to i64
  %t187 = getelementptr [110 x i32], [110 x i32]* @array, i64 0, i64 %t186
  %.v129 = load i32, i32* %t187
  %.v130 = sub i32 0, 1
