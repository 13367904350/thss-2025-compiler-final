...
entry:
  ...
  store i32 0, i32* %iNd__1X
  br label %while.cond1
while.cond1:
  %.v1 = load i32, i32* %iNd__1X
  %.v2 = load i32*, i32** %str.addr
  %.v3 = getelementptr i32, i32* %.v2, i32 %.v1
  %.v4 = load i32, i32* %.v3
  %.v5 = icmp ne i32 %.v4, 0
  br i1 %.v5, label %while.body2, label %while.end3
while.body2:
  %.v6 = load i32, i32* %iNd__1X
  %.v7 = load i32*, i32** %str.addr
  %.v8 = getelementptr i32, i32* %.v7, i32 %.v6
  %.v9 = load i32, i32* %.v8
  call void @putch(i32 %.v9)
  %.v10 = load i32, i32* %iNd__1X
  %.v11 = add i32 %.v10, 1
  store i32 %.v11, i32* %iNd__1X
  br label %while.cond1
while.end3:
  %.v12 = load i32, i32* %iNd__1X
  ret i32 %.v12
}
...
entry:
  ...
  %_ = alloca i32
  %i = alloca i32
  %.v1 = getelementptr [100 x i32], [100 x i32]* @__HELLO, i64 0, i64 0
  %.v2 = call i32 @putstr(i32* %.v1)
  store i32 0, i32* %i
  br label %while.cond1
while.cond1:
  %.v3 = icmp ne i32 1, 0
...
if.then4:
  %.v13 = load i32, i32* %_
  %t25 = getelementptr [6 x [50 x i32]], [6 x [50 x i32]]* @N4__mE___, i64 0, i32 %.v13
  %.v14 = getelementptr [50 x i32], [50 x i32]* %t25, i64 0, i64 0
  %.v15 = call i32 @putstr(i32* %.v14)
  %.v16 = getelementptr [40 x i32], [40 x i32]* @saY_HeI10_To, i64 0, i64 0
  %.v17 = call i32 @putstr(i32* %.v16)
  %.v18 = load i32, i32* %__
  %t31 = getelementptr [6 x [50 x i32]], [6 x [50 x i32]]* @N4__mE___, i64 0, i32 %.v18
  %.v19 = getelementptr [50 x i32], [50 x i32]* %t31, i64 0, i64 0
  %.v20 = call i32 @putstr(i32* %.v19)
  %.v21 = getelementptr [5 x i32], [5 x i32]* @RET, i64 0, i64 0
  %.v22 = call i32 @putstr(i32* %.v21)
  br label %if.end5
if.end5:
  %.v23 = load i32, i32* %i
  %.v24 = mul i32 %.v23, 17
  ...
  br i1 %.v30, label %if.then6, label %if.end7
if.then6:
  br label %while.end3
if.end7:
  br label %while.cond1
