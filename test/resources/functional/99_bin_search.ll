...
while.body2:
  ...
  %.v6 = add i32 %.v5, 1
  %.v7 = load i32, i32* %i
  %t7 = getelementptr [10 x i32], [10 x i32]* %a, i64 0, i32 %.v7
  store i32 %.v6, i32* %t7
  %.v8 = load i32, i32* %i
  %.v9 = add i32 %.v8, 1
  store i32 %.v9, i32* %i
...
while.cond4:
  ...
  %t18 = getelementptr [10 x i32], [10 x i32]* %a, i64 0, i32 %.v18
...
while.body5:
  ...
  %t38 = getelementptr [10 x i32], [10 x i32]* %a, i64 0, i32 %.v37
  %.v38 = load i32, i32* %t38
...
while.end6:
  ...
  %t49 = getelementptr [10 x i32], [10 x i32]* %a, i64 0, i32 %.v47
  %.v48 = load i32, i32* %t49
