...
while.body2:
  ...
  %t8 = getelementptr [4 x i32], [4 x i32]* %a, i64 0, i64 %t7
  store i32 %.v6, i32* %t8
...
while.end3:
  ...
  %t14 = getelementptr [4 x i32], [4 x i32]* %a, i64 0, i64 %t13
  %.v13 = load i32, i32* %t14
  %t16 = sext i32 3 to i64
  %t17 = getelementptr [4 x i32], [4 x i32]* %a, i64 0, i64 %t16
  %.v14 = load i32, i32* %t17
...
land.rhs7:
  ...
  %t26 = getelementptr [4 x i32], [4 x i32]* %a, i64 0, i64 %t25
