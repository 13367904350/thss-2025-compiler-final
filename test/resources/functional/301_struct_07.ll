...
@gp = global %struct.Point {i32 100, i32 200}
declare i32 @getint()
...
entry:
  %.v1 = alloca i32
  store i32 0, i32* %.v1
  %.v2 = getelementptr %struct.Point, %struct.Point* @gp, i32 0, i32 0
  %.v3 = load i32, i32* %.v2
  %.v4 = icmp eq i32 %.v3, 100
...
if.end2:
  ret i32 1
land.rhs3:
  %.v7 = getelementptr %struct.Point, %struct.Point* @gp, i32 0, i32 1
  %.v8 = load i32, i32* %.v7
  %.v9 = icmp eq i32 %.v8, 200
