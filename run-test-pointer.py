...
def generate_llvmir(sysy_file):
    test_dir = Path("./test/resources/pointer")
    if not test_dir.exists():
        return False, "Pointer test directory not found."
...
def main():    
    subprocess.run("rm -f ./test/resources/pointer/*.ll", shell=True)
    subprocess.run("rm -f ./test/resources/pointer/*.output", shell=True)
