...
while.body2:
  ...
  %.v16 = load i32*, i32** %get.addr
  %.v17 = getelementptr i32, i32* %.v16, i32 %.v15
  store i32 %.v14, i32* %.v17
  %.v18 = load i32, i32* %length
  %.v19 = add i32 %.v18, 1
  store i32 %.v19, i32* %length
  %.v20 = call i32 @getch()
  store i32 %.v20, i32* %x
  br label %while.cond1
while.end3:
  %.v21 = load i32, i32* %length
  ret i32 %.v21
land.rhs4:
  %.v7 = load i32, i32* %x
...
entry:
  ...
  %t45 = getelementptr [10000 x i32], [10000 x i32]* @ints, i64 0, i32 %.v4
...
entry:
  ...
  %t50 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v4
  store i32 %.v3, i32* %t50
  ret void
}
...
entry:
  ...
  %.v4 = add i32 %.v3, 1
  %t55 = getelementptr [10000 x i32], [10000 x i32]* @ints, i64 0, i32 %.v4
  %.v5 = load i32, i32* %t55
  ret i32 %.v5
}
...
entry:
  ...
  %.v4 = add i32 %.v3, 1
  %t61 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v4
  %.v5 = load i32, i32* %t61
  ret i32 %.v5
}
...
entry:
  ...
  store i32 %x, i32* %x.addr
  %.v1 = load i32, i32* @intt
  %t64 = getelementptr [10000 x i32], [10000 x i32]* @ints, i64 0, i32 %.v1
  %.v2 = load i32, i32* %t64
  %.v3 = mul i32 %.v2, 10
  %.v4 = load i32, i32* @intt
  %t68 = getelementptr [10000 x i32], [10000 x i32]* @ints, i64 0, i32 %.v4
  store i32 %.v3, i32* %t68
  %.v5 = load i32, i32* @intt
  %t70 = getelementptr [10000 x i32], [10000 x i32]* @ints, i64 0, i32 %.v5
  %.v6 = load i32, i32* %t70
  %.v7 = load i32, i32* %x.addr
  %.v8 = add i32 %.v6, %.v7
  %.v9 = load i32, i32* @intt
  %t75 = getelementptr [10000 x i32], [10000 x i32]* @ints, i64 0, i32 %.v9
  store i32 %.v8, i32* %t75
  ret void
}
...
entry:
  ...
  store i32 %.v1, i32* @c
  %.v2 = load i32, i32* @ii
  %t78 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v2
  store i32 32, i32* %t78
  %.v3 = load i32, i32* @c
  %.v4 = load i32, i32* @ii
  %.v5 = add i32 %.v4, 1
  %t82 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v5
  store i32 %.v3, i32* %t82
  %.v6 = load i32, i32* @ii
  %.v7 = add i32 %.v6, 2
  store i32 %.v7, i32* @ii
...
while.body2:
  %.v8 = load i32, i32* @i
  %t97 = getelementptr [10000 x i32], [10000 x i32]* @get, i64 0, i32 %.v8
  %.v9 = load i32, i32* %t97
...
if.then4:
  %.v14 = load i32, i32* @i
  %t104 = getelementptr [10000 x i32], [10000 x i32]* @get, i64 0, i32 %.v14
  %.v15 = load i32, i32* %t104
  %.v16 = load i32, i32* @ii
  %t107 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v16
  store i32 %.v15, i32* %t107
  %.v17 = load i32, i32* @ii
  %.v18 = add i32 %.v17, 1
...
if.else5:
  %.v19 = load i32, i32* @i
  %t111 = getelementptr [10000 x i32], [10000 x i32]* @get, i64 0, i32 %.v19
...
if.end8:
  %.v24 = load i32, i32* @i
  %t117 = getelementptr [10000 x i32], [10000 x i32]* @get, i64 0, i32 %.v24
  %.v25 = load i32, i32* %t117
...
if.end10:
  %.v29 = load i32, i32* @i
  %t123 = getelementptr [10000 x i32], [10000 x i32]* @get, i64 0, i32 %.v29
  %.v30 = load i32, i32* %t123
...
if.end12:
  %.v46 = load i32, i32* @i
  %t143 = getelementptr [10000 x i32], [10000 x i32]* @get, i64 0, i32 %.v46
  %.v47 = load i32, i32* %t143
...
while.body14:
  %.v39 = load i32, i32* @ii
  %t134 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v39
  store i32 32, i32* %t134
  %.v40 = load i32, i32* @c
  %.v41 = load i32, i32* @ii
  %.v42 = add i32 %.v41, 1
  %t138 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v42
  store i32 %.v40, i32* %t138
  %.v43 = load i32, i32* @ii
  %.v44 = add i32 %.v43, 2
...
if.end17:
  %.v105 = load i32, i32* @i
  %t204 = getelementptr [10000 x i32], [10000 x i32]* @get, i64 0, i32 %.v105
  %.v106 = load i32, i32* %t204
...
while.cond18:
  ...
  %t149 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v56
  %.v57 = load i32, i32* %t149
...
lor.rhs21:
  ...
  %t155 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v61
  %.v62 = load i32, i32* %t155
...
lor.rhs23:
  ...
  %t164 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v69
  %.v70 = load i32, i32* %t164
...
lor.rhs25:
  ...
  %t173 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v77
  %.v78 = load i32, i32* %t173
...
lor.rhs27:
  ...
  %t182 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v85
  %.v86 = load i32, i32* %t182
...
lor.rhs29:
  ...
  %t191 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v93
  %.v94 = load i32, i32* %t191
...
if.end34:
  %.v164 = load i32, i32* @i
  %t265 = getelementptr [10000 x i32], [10000 x i32]* @get, i64 0, i32 %.v164
  %.v165 = load i32, i32* %t265
...
while.cond35:
  ...
  %t210 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v115
  %.v116 = load i32, i32* %t210
...
lor.rhs38:
  ...
  %t216 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v120
  %.v121 = load i32, i32* %t216
...
lor.rhs40:
  ...
  %t225 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v128
  %.v129 = load i32, i32* %t225
...
lor.rhs42:
  ...
  %t234 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v136
  %.v137 = load i32, i32* %t234
...
lor.rhs44:
  ...
  %t243 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v144
  %.v145 = load i32, i32* %t243
...
lor.rhs46:
  ...
  %t252 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v152
  %.v153 = load i32, i32* %t252
...
if.end51:
  %.v205 = load i32, i32* @i
  %t308 = getelementptr [10000 x i32], [10000 x i32]* @get, i64 0, i32 %.v205
  %.v206 = load i32, i32* %t308
...
while.cond52:
  ...
  %t271 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v172
  %.v173 = load i32, i32* %t271
...
lor.rhs55:
  ...
  %t277 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v177
  %.v178 = load i32, i32* %t277
...
lor.rhs57:
  ...
  %t286 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v185
  %.v186 = load i32, i32* %t286
...
lor.rhs59:
  ...
  %t295 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v193
  %.v194 = load i32, i32* %t295
...
if.end64:
  %.v246 = load i32, i32* @i
  %t351 = getelementptr [10000 x i32], [10000 x i32]* @get, i64 0, i32 %.v246
  %.v247 = load i32, i32* %t351
...
while.cond65:
  ...
  %t314 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v213
  %.v214 = load i32, i32* %t314
...
lor.rhs68:
  ...
  %t320 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v218
  %.v219 = load i32, i32* %t320
...
lor.rhs70:
  ...
  %t329 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v226
  %.v227 = load i32, i32* %t329
...
lor.rhs72:
  ...
  %t338 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v234
  %.v235 = load i32, i32* %t338
...
if.end77:
  ...
  %t394 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v287
  store i32 32, i32* %t394
...
while.cond78:
  ...
  %t357 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v254
  %.v255 = load i32, i32* %t357
...
lor.rhs81:
  ...
  %t363 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v259
  %.v260 = load i32, i32* %t363
...
lor.rhs83:
  ...
  %t372 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v267
  %.v268 = load i32, i32* %t372
...
lor.rhs85:
  ...
  %t381 = getelementptr [10000 x i32], [10000 x i32]* @chas, i64 0, i32 %.v275
  %.v276 = load i32, i32* %t381
...
while.body90:
  ...
  %t405 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v297
  store i32 32, i32* %t405
  %.v298 = load i32, i32* %c
  %.v299 = load i32, i32* @ii
  %.v300 = add i32 %.v299, 1
  %t409 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v300
  store i32 %.v298, i32* %t409
...
while.end91:
  ...
  %t413 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v303
  store i32 64, i32* %t413
  store i32 1, i32* @i
  br label %while.cond92
while.cond92:
  %.v304 = load i32, i32* @i
  %t415 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v304
  %.v305 = load i32, i32* %t415
...
while.body93:
  ...
  %.v314 = load i32, i32* @i
  %t421 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v314
  %.v315 = load i32, i32* %t421
  %.v316 = icmp eq i32 %.v315, 43
  %.v317 = zext i1 %.v316 to i32
  %.v318 = icmp ne i32 %.v317, 0
  br i1 %.v318, label %lor.end99, label %lor.rhs98
while.end94:
  %t560 = getelementptr [10000 x i32], [10000 x i32]* @ints, i64 0, i32 1
  %.v438 = load i32, i32* %t560
...
if.then95:
  ...
  %.v361 = load i32, i32* @i
  %t474 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v361
  %.v362 = load i32, i32* %t474
...
if.else96:
  %.v410 = load i32, i32* @i
  %t529 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v410
  %.v411 = load i32, i32* %t529
...
lor.rhs98:
  %.v319 = load i32, i32* @i
  %t427 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v319
  %.v320 = load i32, i32* %t427
...
lor.rhs100:
  %.v327 = load i32, i32* @i
  %t436 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v327
  %.v328 = load i32, i32* %t436
...
lor.rhs102:
  %.v335 = load i32, i32* @i
  %t445 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v335
  %.v336 = load i32, i32* %t445
...
lor.rhs104:
  %.v343 = load i32, i32* @i
  %t454 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v343
  %.v344 = load i32, i32* %t454
...
lor.rhs106:
  %.v351 = load i32, i32* @i
  %t463 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v351
  %.v352 = load i32, i32* %t463
...
if.end109:
  %.v369 = load i32, i32* @i
  %t483 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v369
  %.v370 = load i32, i32* %t483
...
if.end111:
  %.v377 = load i32, i32* @i
  %t492 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v377
  %.v378 = load i32, i32* %t492
...
if.end113:
  %.v385 = load i32, i32* @i
  %t501 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v385
  %.v386 = load i32, i32* %t501
...
if.end115:
  %.v393 = load i32, i32* @i
  %t510 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v393
  %.v394 = load i32, i32* %t510
...
if.end117:
  %.v401 = load i32, i32* @i
  %t519 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v401
  %.v402 = load i32, i32* %t519
...
if.then120:
  %.v415 = load i32, i32* @i
  %t535 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v415
  %.v416 = load i32, i32* %t535
...
while.cond122:
  ...
  %t541 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v420
  %.v421 = load i32, i32* %t541
...
while.body123:
  ...
  %t549 = getelementptr [10000 x i32], [10000 x i32]* @get2, i64 0, i32 %.v427
  %.v428 = load i32, i32* %t549
