...
while.body2:
  %.v8 = load i32, i32* %i
  %t8 = getelementptr [50 x i32], [50 x i32]* @ans, i64 0, i32 %.v8
  %.v9 = load i32, i32* %t8
...
while.body2:
  ...
  store i32 0, i32* %.v7
  %.v8 = load i32, i32* %i
  %t23 = getelementptr [50 x i32], [50 x i32]* @row, i64 0, i32 %.v8
  %.v9 = load i32, i32* %t23
...
if.then4:
  ...
  %t54 = getelementptr [50 x i32], [50 x i32]* @ans, i64 0, i32 %.v36
  store i32 %.v35, i32* %t54
...
land.rhs6:
  ...
  %.v14 = load i32, i32* %i
  %.v15 = add i32 %.v13, %.v14
  %t31 = getelementptr [50 x i32], [50 x i32]* @line1, i64 0, i32 %.v15
...
land.rhs8:
  ...
  %.v26 = load i32, i32* %i
  %.v27 = sub i32 %.v25, %.v26
  %t44 = getelementptr [100 x i32], [100 x i32]* @line2, i64 0, i32 %.v27
  %.v28 = load i32, i32* %t44
...
if.end11:
  %.v42 = load i32, i32* %i
  %t61 = getelementptr [50 x i32], [50 x i32]* @row, i64 0, i32 %.v42
  store i32 1, i32* %t61
  %.v43 = load i32, i32* %step.addr
  %.v44 = load i32, i32* %i
  %.v45 = add i32 %.v43, %.v44
  %t65 = getelementptr [50 x i32], [50 x i32]* @line1, i64 0, i32 %.v45
  store i32 1, i32* %t65
  %.v46 = load i32, i32* @n
  ...
  %.v49 = load i32, i32* %i
  %.v50 = sub i32 %.v48, %.v49
  %t71 = getelementptr [100 x i32], [100 x i32]* @line2, i64 0, i32 %.v50
  store i32 1, i32* %t71
  %.v51 = load i32, i32* %step.addr
  %.v52 = add i32 %.v51, 1
  call void @f(i32 %.v52)
  %.v53 = load i32, i32* %i
  %t75 = getelementptr [50 x i32], [50 x i32]* @row, i64 0, i32 %.v53
  store i32 0, i32* %t75
  %.v54 = load i32, i32* %step.addr
  %.v55 = load i32, i32* %i
  %.v56 = add i32 %.v54, %.v55
  %t79 = getelementptr [50 x i32], [50 x i32]* @line1, i64 0, i32 %.v56
  store i32 0, i32* %t79
  %.v57 = load i32, i32* @n
  ...
  %.v60 = load i32, i32* %i
  %.v61 = sub i32 %.v59, %.v60
  %t85 = getelementptr [100 x i32], [100 x i32]* @line2, i64 0, i32 %.v61
  store i32 0, i32* %t85
  br label %if.end5
}
